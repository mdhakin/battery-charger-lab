...
void Battery::installInSlot() { isInstalled_ = true; }

void Battery::removeFromSlot() { isInstalled_ = false; }

std::uint8_t Battery::getChargeLevel() const { return chargeLevel_; }

bool Battery::isInstalled() const { return isInstalled_; }

bool Battery::isFullycharged() const { return chargeLevel_ == 100; }

BatteryState Battery::getState() const { return state_; }
